...
import { StyleSheet, View, Text, TextInput, AsyncStorage, Alert } from "react-native";
...
export default class main extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch('ip/~Iot/curtain_state.php', {
            method: 'post',
            header: {
                'Accept': 'application/json',
                'Contect-type': 'application/json',
        ...
        fetch('ip/~Iot/air_auto_state.php', {
            method: 'post',
            header: {
                'Accept': 'application/json',
                'Contect-type': 'application/json',
    ...
    logout = () => {
        const { navigate } = this.props.navigation;
        var keyValuePairs = [['Userid', ''], ['Userpassword', '']]
    ...
    changeValue = () => {
        if (this.state.statetext == "on") {
            ...
            fetch('ip/~Iot/off_curtain_auto_state.php')
            this.setState({
                statetext: "off",
            })
            ...
            fetch('ip/~Iot/on_curtain_auto_state.php')
    ...
    air_state = () => {
        if (this.state.air_text == "on") {
            ...
            fetch('ip/~Iot/off_air_auto_state.php')
            this.setState({
                air_text: "off",
            })
            ...
            fetch('ip/~Iot/on_air_auto_state.php')
                ...
                <Grid>
                    ...
                    <Row size={1} justifyContent="center" >
                        ...
                        <Col onPress={this.pwd}>
                            <TextInput editable={false} secureTextEntry={this.state.secure} style={styles.textaccountright} value={this.state.pwd}>
                            </TextInput>
                        </Col>
                        <Col size={0.4} justifyContent ='center' >
                        <Text onPress={this.pwd} style={styles.min}>修改密碼</Text>
                        </Col>
                    </Row>
                    ...
                    <Row size={1}>
                        <Col size={3}><Text style={styles.textaccount}>窗簾自動 {this.state.statetext}</Text></Col>
                        <Col size={0.5}></Col>
                        <Col size={2}>
                            <TouchableOpacity
                                style={{
                                    backgroundColor: "#D2E0E3", borderRadius: 20, flex: 1,
                                    margin: 2, justifyContent: 'center',
                                    alignItems: 'center',
                                }}
                    ...
                    <Row size={1}>
                        <Col size={3}><Text style={styles.textaccount}>空調自動 {this.state.air_text}</Text></Col>
                        <Col size={0.5}></Col>
                        <Col size={2}>
                            <TouchableOpacity
                                style={{
                                    backgroundColor: "#E8CED5", borderRadius: 20, flex: 1,
                                    margin: 2, justifyContent: 'center',
                                    alignItems: 'center',
                                }}
