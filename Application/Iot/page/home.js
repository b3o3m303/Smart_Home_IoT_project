...
export default class main extends React.Component {
    ...
    // unlockFunction = () => {
    //     setTimeout(() => {
    //         fetch('裝置ip/check.php').then((response) => response.json())
    //             .then((responseJson) => {
    //                 var powerswitch = responseJson;
    //                 if (powerswitch == "unlock") {
    //                     Alert.alert("警告", "大門解鎖")
                    ...
                    <Row backgroundColor='#ffffffff' size={1}>
                        <Col backgroundColor='#ffffffff'>
                            <TouchableOpacity
                                ...
                                style={{
                                    backgroundColor: this.state.buttonColor, borderRadius: 30, flex: 1,
                        ...
                        <Col backgroundColor='#ffffffff'><TouchableOpacity style={styles.TOElectric}
                            onPress={this.homeApplication}

                        >
                            <Text style={styles.totext}>家電設定</Text></TouchableOpacity></Col>
                    </Row>
                    <Row backgroundColor='#ffffffff' size={1}>
                        <Col backgroundColor='#ffffffff'><TouchableOpacity style={styles.TOold}
                            onPress={this.personal_num}>
                            <Text style={styles.totext}>屋內人數</Text></TouchableOpacity></Col>
                        <Col backgroundColor='#ffffffff'><TouchableOpacity style={styles.TOpersonal} onPress={this.personal}><Text style={styles.totext}>個人設定</Text></TouchableOpacity></Col>
                    </Row>
                    <Row backgroundColor='#ffffffff' size={1}>
                        <TouchableOpacity onPress={this.unlockFunction} style={styles.unlock}><Text style={styles.unlocktext}>大門解鎖</Text></TouchableOpacity>
                    </Row>
                </Grid>
