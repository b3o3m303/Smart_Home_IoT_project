        ...
        return (
            ...
            <View style={styles.flexContainer}>
                <Grid >
                    ...
                    <Row backgroundColor='#ffffffff' size={1}>
                        <TouchableOpacity style={styles.unlock} onPress={this.curtain}><Text style={styles.unlocktext}>窗簾控制</Text>
                        </TouchableOpacity>
                    </Row>
                    <Row backgroundColor='#ffffffff' size={1}>
                        <TouchableOpacity style={styles.white} onPress={this.air_dialog}><Text style={styles.unlocktext}>空調控制</Text>
                        </TouchableOpacity>
                    </Row>
                    <Row backgroundColor='#ffffffff' size={1}>
                        <TouchableOpacity style={styles.unlock} onPress={this.to_motion}><Text style={styles.unlocktext}>監控控制</Text>
                        </TouchableOpacity>
                    </Row>
                    <Row size={3}>
                    ...
                    <Dialog.Container visible={this.state.danger_on_dialogVisible}>
                        ...
                        <Dialog.Button color='#black' label="關掉" onPress={this.handleCancel_danger_on} />
                        <Dialog.Button color='red' label="不要" onPress={this.handleDelete_danger_on} />
                    </Dialog.Container>
                    ...
                    <Dialog.Container visible={this.state.danger_off_dialogVisible}>
                        ...
                        <Dialog.Button color='red' label="關閉視窗" onPress={this.handleDelete_danger_off} />
                    </Dialog.Container>
                </Grid>
            </View>
