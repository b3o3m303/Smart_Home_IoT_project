            ...
            <View style={styles.flexContainer}>
                ...
                <Grid >
                    ...
                    <Row size={1.5} style={styles.center}>
                        <Icon name='snowflake-o' type='font-awesome' color='#ffffff' size={60}></Icon>
                    </Row>
                    <Row size={1.5} style={styles.center}>
                        <Col size={0.2}></Col>
                        <Col size={1}><Icon name='oil-temperature' type='material-community' color='red' size={35}></Icon></Col>
                        <Col size={3}>
                            <Text style={styles.bttext}>溫度{this.state.gettemp}℃</Text></Col>
                        <Col size={0.2}></Col>
                        <Col size={0.5}><Icon name='ios-water' type='ionicon' color='#1E518A' size={35}></Icon></Col>
                        <Col size={3}><Text style={styles.bttext}>濕度{this.state.gethumi}%</Text></Col>
                    </Row>
                    ...
                    <Row size={1.5} style={styles.center}><Text style={styles.bttext}>空調自動：</Text>
                    ...
                    <Row size={1.5}>
                        <TouchableOpacity style={styles.unlock} disabled={this.state.buttonstate}
                            onPress={this.air_on}
                        ><Text style={styles.unlocktext}>打開</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.lock} disabled={this.state.buttonstate}
